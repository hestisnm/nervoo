...
class Kelas9Page extends StatefulWidget {
  const Kelas9Page({super.key});

  @override
  State<Kelas9Page> createState() => _Kelas9PageState();
}

class _Kelas9PageState extends State<Kelas9Page>
